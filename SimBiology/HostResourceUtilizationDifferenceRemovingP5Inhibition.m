%--------------------------------------------------------------------------
%Model Run------------------Version 3----------------------April 29th, 2013
%--------------------------------------------------------------------------
clc; clear all 
...
%When the folowing variable "WhichOneToInhibit" is equal to 61 it means P5
%will not inhibit the translation of P2, the following other numbers
%are also valid for this variable. 
%P2 - 61; P10 - 62; P5 - 63; P3 - 64; P1 - 65 
WhichOneToInhibit = 63; 
...
P(56) = .1;           %Rate of assembly site formation (1/(Second*Molecule)) 
P(57) = .1;           %Rate of P7/P9 forming a complex with an assembly site (1/(Second*Molecule^2)) 
P(58) = .1;           %Rate of P5DNA binding to assembly site containt p7 and P9 (1/(Second*Molecule)) 
...
P(68) = 1;   %This the the cooperative hill coefficent constant 
%--------------------------------------------------------------------------
...
for J = 1:length(WhichOneToInhibit)  %Just in case I want to turn off more 
                                     %than one inhibition i can use
                                     %WhichOneToInhibit value as a vector
    m1.parameters(WhichOneToInhibit).value = 10E30; 
end  
[t1,x1] = sbiosimulate(m1); 
