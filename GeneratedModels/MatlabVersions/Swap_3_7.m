function [err, timepoints, species_out, observables_out] = Swap_3_7( timepoints, species_init, parameters, suppress_plot )
%SWAP_3_7 Integrate reaction network and plot observables.
%   Integrates the reaction network corresponding to the BioNetGen model
%   'Swap_3_7' and then (optionally) plots the observable trajectories,
...
%   'ode15s'. SWAP_3_7 returns an error value, a vector of timepoints,
%   species trajectories, and observable trajectories.
%   
%   [err, timepoints, species_out, observables_out]
%        = Swap_3_7( timepoints, species_init, parameters, suppress_plot )
%
%   INPUTS:
%   -------
...
if ( ~suppress_plot )
    ...
    title('Swap_3_7 observables','fontSize',14,'Interpreter','none');
