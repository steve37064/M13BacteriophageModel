function [err, timepoints, species_out, observables_out] = Remake_Original( timepoints, species_init, parameters, suppress_plot )
%REMAKE_ORIGINAL Integrate reaction network and plot observables.
%   Integrates the reaction network corresponding to the BioNetGen model
%   'Remake_Original' and then (optionally) plots the observable trajectories,
...
%   'ode15s'. REMAKE_ORIGINAL returns an error value, a vector of timepoints,
%   species trajectories, and observable trajectories.
%   
%   [err, timepoints, species_out, observables_out]
%        = Remake_Original( timepoints, species_init, parameters, suppress_plot )
%
%   INPUTS:
%   -------
...
if ( ~suppress_plot )
    ...
    title('Remake_Original observables','fontSize',14,'Interpreter','none');
