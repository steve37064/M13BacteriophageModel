function [err, timepoints, species_out, observables_out] = Swap_4_6( timepoints, species_init, parameters, suppress_plot )
%SWAP_4_6 Integrate reaction network and plot observables.
%   Integrates the reaction network corresponding to the BioNetGen model
%   'Swap_4_6' and then (optionally) plots the observable trajectories,
...
%   'ode15s'. SWAP_4_6 returns an error value, a vector of timepoints,
%   species trajectories, and observable trajectories.
%   
%   [err, timepoints, species_out, observables_out]
%        = Swap_4_6( timepoints, species_init, parameters, suppress_plot )
%
%   INPUTS:
%   -------
...
if ( ~suppress_plot )
    ...
    title('Swap_4_6 observables','fontSize',14,'Interpreter','none');
...
function [ ratelaws ] = calc_ratelaws ( species, expressions, observables )
    ...
    ratelaws(39) = rateLaw__17(expressions,observables)*species(32)*species(43);
    ratelaws(40) = rateLaw__18(expressions,observables)*species(33)*species(41)*species(42)*species(40)*species(44);
    ratelaws(41) = rateLaw__19(expressions,observables)*species(34)*species(41)*species(42);
