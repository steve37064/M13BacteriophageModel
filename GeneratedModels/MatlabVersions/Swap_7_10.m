function [err, timepoints, species_out, observables_out] = Swap_7_10( timepoints, species_init, parameters, suppress_plot )
%SWAP_7_10 Integrate reaction network and plot observables.
%   Integrates the reaction network corresponding to the BioNetGen model
%   'Swap_7_10' and then (optionally) plots the observable trajectories,
...
%   'ode15s'. SWAP_7_10 returns an error value, a vector of timepoints,
%   species trajectories, and observable trajectories.
%   
%   [err, timepoints, species_out, observables_out]
%        = Swap_7_10( timepoints, species_init, parameters, suppress_plot )
%
%   INPUTS:
%   -------
...
if ( ~suppress_plot )
    ...
    title('Swap_7_10 observables','fontSize',14,'Interpreter','none');
