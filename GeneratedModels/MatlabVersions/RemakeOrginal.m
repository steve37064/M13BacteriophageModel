function [err, timepoints, species_out, observables_out] = RemakeOrginal( timepoints, species_init, parameters, suppress_plot )
%REMAKEORGINAL Integrate reaction network and plot observables.
%   Integrates the reaction network corresponding to the BioNetGen model
%   'RemakeOrginal' and then (optionally) plots the observable trajectories,
...
%   'ode15s'. REMAKEORGINAL returns an error value, a vector of timepoints,
%   species trajectories, and observable trajectories.
%   
%   [err, timepoints, species_out, observables_out]
%        = RemakeOrginal( timepoints, species_init, parameters, suppress_plot )
%
%   INPUTS:
%   -------
...
if ( ~suppress_plot )
    ...
    title('RemakeOrginal observables','fontSize',14,'Interpreter','none');
