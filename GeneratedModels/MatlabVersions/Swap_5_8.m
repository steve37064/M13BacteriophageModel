function [err, timepoints, species_out, observables_out] = Swap_5_8( timepoints, species_init, parameters, suppress_plot )
%SWAP_5_8 Integrate reaction network and plot observables.
%   Integrates the reaction network corresponding to the BioNetGen model
%   'Swap_5_8' and then (optionally) plots the observable trajectories,
...
%   'ode15s'. SWAP_5_8 returns an error value, a vector of timepoints,
%   species trajectories, and observable trajectories.
%   
%   [err, timepoints, species_out, observables_out]
%        = Swap_5_8( timepoints, species_init, parameters, suppress_plot )
%
%   INPUTS:
%   -------
...
if ( ~suppress_plot )
    ...
    title('Swap_5_8 observables','fontSize',14,'Interpreter','none');
...
function [ ratelaws ] = calc_ratelaws ( species, expressions, observables )
    ...
    ratelaws(31) = rateLaw__9(expressions,observables)*species(27)*species(39)*species(38)*species(37);
    ratelaws(32) = (0.7*expressions(25))*species(28);
    ratelaws(33) = rateLaw__11(expressions,observables)*species(28)*species(39)*species(38)*species(37);
    ratelaws(34) = rateLaw__12(expressions,observables)*species(29)*species(39);
    ratelaws(35) = rateLaw__13(expressions,observables)*species(29)*species(39)*species(38)*species(37);
    ratelaws(36) = (0.7*expressions(27))*species(30);
    ratelaws(37) = rateLaw__15(expressions,observables)*species(30)*species(38)*species(37);
    ratelaws(38) = rateLaw__16(expressions,observables)*species(31)*species(38)*species(37);
