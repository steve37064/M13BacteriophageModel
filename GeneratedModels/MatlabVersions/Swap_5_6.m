function [err, timepoints, species_out, observables_out] = Swap_5_6( timepoints, species_init, parameters, suppress_plot )
%SWAP_5_6 Integrate reaction network and plot observables.
%   Integrates the reaction network corresponding to the BioNetGen model
%   'Swap_5_6' and then (optionally) plots the observable trajectories,
...
%   'ode15s'. SWAP_5_6 returns an error value, a vector of timepoints,
%   species trajectories, and observable trajectories.
%   
%   [err, timepoints, species_out, observables_out]
%        = Swap_5_6( timepoints, species_init, parameters, suppress_plot )
%
%   INPUTS:
%   -------
...
if ( ~suppress_plot )
    ...
    title('Swap_5_6 observables','fontSize',14,'Interpreter','none');
...
function [ ratelaws ] = calc_ratelaws ( species, expressions, observables )
    ...
    ratelaws(31) = rateLaw__9(expressions,observables)*species(27)*species(43)*species(38)*species(39);
    ratelaws(32) = (0.7*expressions(25))*species(28);
    ratelaws(33) = rateLaw__11(expressions,observables)*species(28)*species(43)*species(38)*species(39);
    ratelaws(34) = rateLaw__12(expressions,observables)*species(29)*species(43);
    ratelaws(35) = rateLaw__13(expressions,observables)*species(29)*species(43)*species(38)*species(39);
    ...
    ratelaws(40) = rateLaw__18(expressions,observables)*species(33)*species(41)*species(37)*species(40)*species(44);
    ratelaws(41) = rateLaw__19(expressions,observables)*species(34)*species(41)*species(37);
